export const DescriptionText = [
  {
    id: 0,
    text: "Desenvolvedor fullstack com experiência em projetos de pequeno, médio e grande porte, conhecimento consolidado em React, React Native, Typescript, Redux, NextJs e Jest",
  },
  {
    id: 1,
